...
namespace SGA.ModuloGestaoAtivo.Controllers
{
    public class DefaultController : Controller
    {
        ...
        public readonly ISgaAtivoApiClient _sgaAtivoApiClient;
        public DefaultController(IViewRenderService viewRenderService, ISgaAtivoApiClient sgaAtivoApiClient)
        {
            _viewRenderService = viewRenderService;
            _sgaAtivoApiClient = sgaAtivoApiClient;
        }
